...
public class MonoidGallery : PresentationGallery {
    ...
    static readonly PresentationExample[] monoids = {
        ...
        new FreeGroup() { groupMode = CayleyGraphMaker.GroupMode.Monoid, name = "A*", description = "The free monoid over n generators", tooltipInfo = "The free monoid over the alphabet A = {a, b, ...} consists of words in these generators. The free group can be understood as the free monoid over the generators and formal inverses together with the relations aA=Aa=1, and so on. All monoids and groups defined from presentations like here arise as quotients of the free monoid, which forms a rooted tree.", tooltipURL = "https://en.wikipedia.org/wiki/Free_monoid"},
