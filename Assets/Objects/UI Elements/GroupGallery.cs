...
public class GroupGallery : MonoBehaviour
{
    ...
    string[][] groupList = {
        ...
        new string[] {"ℤ²", "Z² from two generators", "a, b", "abAB"},
        new string[] {"ℤ²", "Z² from three generators", "a, b, c", "abAB, abC"},
        ...
        new string[] {"F", "Thompson group F", "a, b", "aBAbabAABa, aBAAbaabAAABaa"},
